...
blaunch --cpus 8 --mem 64 -L confrml:1 --jobname {jobname} --mail -L confrml launch -c cdns/confrml -- lec -nogui -lp -xl -dofile {rtl_rtl_do_name} -logfile {logfile_name}
'''
...
blaunch --cpus 8 --mem 64 --jobname {jobname} --mail -L confrml launch -c cdns/confrml -- lec -nogui -lp -xl -dofile {do_file} -logfile {logfile_name}
'''
